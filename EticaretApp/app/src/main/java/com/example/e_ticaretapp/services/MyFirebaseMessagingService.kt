...
import com.example.e_ticaretapp.ui.notifications.NotificationsViewModel
...
class MyFirebaseMessagingService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        NotificationsViewModel.notifications.add(NotificationObject(remoteMessage.data.toString()))
    ...
    private fun sendNotification(messageBody: String) {
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            .setContentTitle("Your order has been received")
